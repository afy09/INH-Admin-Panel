        ...
        <div className="fixed inset-0 bg-black-2 bg-opacity-75 z-999999 flex items-center justify-center text-black-2">
          <div className="bg-white rounded-lg p-6 w-[90%] max-w-md relative ms-30">
            ...
            <div className="text-sm space-y-2">
              ...
              <p className="flex justify-between">
                <strong>Jumlah Pembayaran :</strong> {selectedTransaksi.credit.toLocaleString("id-ID", { style: "currency", currency: "IDR" })}
              </p>
              <p className="flex justify-between">
                <strong>Status :</strong> <span className="px-2 py-1 bg-green-100 rounded-lg">{selectedTransaksi.status}</span>
              </p>
              <p className="flex justify-between">
                <strong>Metode Pembayaran :</strong> {selectedTransaksi.paymentMethod}
              </p>
              <p className="flex justify-between">
